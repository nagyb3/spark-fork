...
class AppStatusStoreSuite extends SparkFunSuite {
  ...
  private def newTaskData(i: Int, status: String = "SUCCESS"): TaskDataWrapper = {
    new TaskDataWrapper(
      ...
      memoryBytesSpilled = i,
      diskBytesSpilled = i,
      peakExecutionMemory = i,
      inputBytesRead = i,
      inputRecordsRead = i,
      outputBytesWritten = i,
      outputRecordsWritten = i,
      shuffleRemoteBlocksFetched = i,
      shuffleLocalBlocksFetched = i,
      shuffleFetchWaitTime = i,
      shuffleRemoteBytesRead = i,
      shuffleRemoteBytesReadToDisk = i,
      shuffleLocalBytesRead = i,
      shuffleRecordsRead = i,
      shuffleCorruptMergedBlockChunks = i,
      shuffleMergedFetchFallbackCount = i,
      shuffleMergedRemoteBlocksFetched = i,
      shuffleMergedLocalBlocksFetched = i,
      shuffleMergedRemoteChunksFetched = i,
      shuffleMergedLocalChunksFetched = i,
      shuffleMergedRemoteBytesRead = i,
      shuffleMergedLocalBytesRead = i,
      shuffleRemoteReqsDuration = i,
      shuffleMergedRemoteReqDuration = i,
